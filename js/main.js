...
function startGame() {
  ...
  gameRunning = true
// musik wird direkt anch start klick gespielt
  sound.currentTime=0;    // falls neu gestartet wird
  sound.play()
...
function handleJump(e) {
  ...
  if (e.code === 'Space' || e.code === 'ArrowUp') {
    ...
    jumpTimeout = setTimeout(() => {
     ...
     jumpSound.currentTime=0;    // falls neu gestartet wird
     jumpSound.play()
  }
}
...
function endGame() {
  ...
  //musik stoppen
  sound.pause()
  sound.currentTime=0;     // zurückspulen zum anfang /neustart
